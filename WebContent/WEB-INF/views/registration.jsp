...
<body>
<form:form  class="well form-horizontal" method="POST" modelAttribute="customer" >
 <div class="container">
 <fieldset>
				  ...
				  <div class="form-group">
				     ...
				     <div class="form-group">
					  <label class="col-md-4 control-label" >Confirm Password</label> 
					    ...
					    <div class="input-group">
					  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
					  <form:input path="confirmpassword" placeholder="Confirm Password" class="form-control" id="confirmpassword" type="password"/>
					    </div>
					  </div>
					</div>
    ...
    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="/Online_Bike_Booking_Customizing/Login/log">Already register?</a>
  </fieldset>
 </div>
</form:form>
