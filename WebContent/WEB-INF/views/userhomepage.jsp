   ...
   <!--   <div class="col-sm-3">-->
    <div class="thumbnail">
      ...
      <div class="caption">
        ...
        <p><a href="/Online_Bike_Booking_Customizing/homepage/product?idparam=${item.bikeId}"  class="btn btn-primary" role="button"   >Detail</a> <a href="/Online_Bike_Booking_Customizing/OrderController/bike?idparam=${item.bikeId}" class="btn btn-default" role="button">Book Now</a></p>
      </div>
   <!-- </div>--> 
  </div>
</div>
