   ...
   <div class="caption">
        ...
        <h3>${sessionScope.serachbike.price}</h3></div>
         ...
         <form name="OptionMaker" action="/Online_Bike_Booking_Customizing/OrderController/order" method="post">
					<h4>BikeName</h4><div class="product-title">${sessionScope.serachbike.bikeName}</div>
					<hr>
					<h4>BikeDescription</h4><div class="product-desc">${sessionScope.serachbike.bikeDescription}</div>
					<div class="product-rating"><i class="fa fa-star gold"></i> <i class="fa fa-star gold"></i> <i class="fa fa-star gold"></i> <i class="fa fa-star gold"></i> <i class="fa fa-star-o"></i> </div>
					<hr>
					<h4>Price</h4><div class="product-price">${sessionScope.serachbike.price}</div>
					<hr>
					 <p>
